...
# Sainsburys Bank - Web - Lesson 1 - Practical Exercise
...
```sh
git clone https://github.com/Manual-To-Automation-Sainsburys-Bank/Web-Lesson-1-Exercise.git
```

Move into the directory:

```sh
cd Web-Lesson-1-Exercise
```

Type the following commands:

```sh
npm run login-success
```

```sh
npm run login-failed-username
```

```sh
npm run login-failed-password
```
